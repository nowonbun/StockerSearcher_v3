...
def build_prediction_spec() -> PredictionSpec:
    return PredictionSpec(
        "JP", weekly_split_source("JP"), "stock_predict_week_jp", "model_week_jp", "model_week_jp_v3", "model_week_jp_v3.pt", 120, 20, 0.09, 30,
        ...
        default_max_extension_ratio=0.50, model_mode="v3_trend_filtered_upside_probability_week_jp",
    )
